...
from components.parser.exceptions import (
    AllStrategiesFailedError,
    ParserNotFoundError,
)
from components.parser.logging_setup import get_logger
from components.parser.routing.scanned_detector import is_scanned_pdf
...
class ParserRouter:
    ...
    def _create_strategy(self, name: str) -> Any:
        ...
        from components.parser.components.docling_strategy import DoclingParser
        from components.parser.components.ocr_cloud import CloudOCRParser
        from components.parser.components.ocr_local import LocalOCRParser
        from components.parser.components.pypdf_strategy import PyPDFParser
        from components.parser.components.simple import SimpleParser
        from components.parser.components.structured import StructuredParser
