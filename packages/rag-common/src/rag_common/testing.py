...
from rag_common.schemas import META_KEY_SPEC
...
def log_context_reset() -> Generator[None, None, None]:
    ...
    """
    from rag_common.logging import _log_context_var
...
def mock_http_provider(
    ...
    Usage::
        ...
        with patch("rag_parser.components.ocr_cloud.httpx.Client") as mock_client:
